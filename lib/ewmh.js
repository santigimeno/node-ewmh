...
EWMH.prototype.set_class = function(wid, class, cb) {
    this._change_utf8_property(wid, 'WM_CLASS', class, cb);
};
...
EWMH.set_window_manager_owner = function(wid, name, class, cb) {
    var self = this;
    async.parallel([
        function(cb) {
